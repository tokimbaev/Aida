...
class EducationPlatform {
    ...
    initializeStorage() {
        ...
        // Создаем демо-лекции если их нет
    ...
    handleAddLecture(e) {
        ...
        // В демо-версии используем заглушку для видео
        const demoVideoUrl = 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4';
        ...
        this.showAlert('Лекция успешно загружена! В демо-версии используется стандартное видео.', 'success');
    }
            ...
            allLecturesList.innerHTML = lectures.map(lecture => `
                <div class="lecture-item-admin">
                    <div>
                        ...
                        <br>
                        <small>Учитель: ${lecture.teacher} | Дата: ${lecture.date} | Размер: ${this.formatFileSize(lecture.size)}</small>
                    </div>
                    <button class="btn btn-small btn-danger" onclick="platform.deleteLecture(${lecture.id})">
                        Удалить
                    </button>
